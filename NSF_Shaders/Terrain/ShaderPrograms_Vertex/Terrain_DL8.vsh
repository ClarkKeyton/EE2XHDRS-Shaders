...
;
;Dynamic light 3
;CM_Global =	DL_3_Position = 		c103
;CM_Global =	DL_3_Radius = 			c104.x = reciprocal of squared radius
;CM_Global =	DL_3_Color = 			c105
;
;Dynamic light 4
;CM_Global =	DL_4_Position = 		c106
;CM_Global =	DL_4_Radius = 			c107.x = reciprocal of squared radius
;CM_Global =	DL_4_Color = 			c108
;
;Dynamic light 5
;CM_Global =	DL_5_Position = 		c109
;CM_Global =	DL_5_Radius = 			c110.x = reciprocal of squared radius
;CM_Global =	DL_5_Color = 			c111
;
;Dynamic light 6
;CM_Global =	DL_6_Position = 		c112
;CM_Global =	DL_6_Radius = 			c113.x = reciprocal of squared radius
;CM_Global =	DL_6_Color = 			c114
;
;Dynamic light 7
;CM_Global =	DL_7_Position = 		c115
;CM_Global =	DL_7_Radius = 			c116.x = reciprocal of squared radius
;CM_Global =	DL_7_Color = 			c117
;
;Dynamic light 7
;CM_Global =	DL_7_Position = 		c118
;CM_Global =	DL_7_Radius = 			c119.x = reciprocal of squared radius
;CM_Global =	DL_7_Color = 			c120
;
;
...
;----------------------------
; Lighting - Dynamic light 3
;
; Compute light vector (light position - vertex position)
sub		r4, c103, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c104.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
...
;----------------------------
; Lighting - Dynamic light 4
;
; Compute light vector (light position - vertex position)
sub		r4, c106, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c107.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
...
;----------------------------
; Lighting - Dynamic light 5
;
; Compute light vector (light position - vertex position)
sub		r4, c109, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c110.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
...
;----------------------------
; Lighting - Dynamic light 6
;
; Compute light vector (light position - vertex position)
sub		r4, c112, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c113.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
...
;----------------------------
; Lighting - Dynamic light 7
;
; Compute light vector (light position - vertex position)
sub		r4, c115, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c116.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
...
;----------------------------
; Lighting - Dynamic light 8
;
; Compute light vector (light position - vertex position)
sub		r4, c118, r9											;r4 = vertex - light position
; Normalize light vector
dp3		r3.x, r4, r4
rsq		r2.x, r3.x
mul		r6, r4.xyz, r2.xxx
mul		r7.x, r3.x, c119.x									; r7.x = squared distance from vertex light -DO NOT MODIFY-
; Compute percent of light touching this vertex as directional light + dynamic embiant
dp3		r2.xyz, r11, r6
mov		r10.xyz, c96.xxx
max		r0.xyz, r2, r10
