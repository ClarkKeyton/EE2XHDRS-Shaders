...
// a solid (not skinned) object, four dynamic lights,
...
// c105	= DL3_PositionAndRadius		(xyz = position, w = 1/r^2)
// c106	= DL3_Color					(Color)
// c107	= DL4_PositionAndRadius		(xyz = position, w = 1/r^2)
// c108	= DL4_Color					(Color)
//
// output:
...
// dynamic light 3
// -------------------------------------------
// r5	= lighting contribution from dynamic light 3

// compute (normalized) light vector (light pos - vertex pos) 
// (r8 = light vector, r9.x = magnitude^2, r9.y = 1/magnitude)
sub		r8.xyz, c105.xyz, r0.xyz
dp3		r9.x, r8.xyz, r8.xyz		// compute magnitude^2
rsq		r9.y, r9.x					// compute 1 / magnitude
mul		r8.xyz, r8.xyz, r9.yyy		// normalize
...
// apply distance falloff
mul		r9.x, r9.x, c105.w			// dist^2 / r^2
sub		r9.x, c5.y, r9.x			// 1 - dist^2 / r^2
max		r9.x, r9.x, c5.x			// clamp to 0
mul		r10.xyz, r10.xyz, r9.xxx	// attenuate

// modulate by light color
mul		r5.xyz, r10.xyz, c106.xyz


// -------------------------------------------
// dynamic light 4
// -------------------------------------------
// r6	= lighting contribution from dynamic light 4

// compute (normalized) light vector (light pos - vertex pos) 
// (r8 = light vector, r9.x = magnitude^2, r9.y = 1/magnitude)
sub		r8.xyz, c107.xyz, r0.xyz
dp3		r9.x, r8.xyz, r8.xyz		// compute magnitude^2
rsq		r9.y, r9.x					// compute 1 / magnitude
mul		r8.xyz, r8.xyz, r9.yyy		// normalize
...
// apply distance falloff
mul		r9.x, r9.x, c107.w			// dist^2 / r^2
sub		r9.x, c5.y, r9.x			// 1 - dist^2 / r^2
max		r9.x, r9.x, c5.x			// clamp to 0
mul		r10.xyz, r10.xyz, r9.xxx	// attenuate

// modulate by light color
mul		r6.xyz, r10.xyz, c108.xyz
...
add		r8.xyz, r8.xyz, r5.xyz			// add dynamic light 3
add		r8.xyz, r8.xyz, r6.xyz			// add dynamic light 4
